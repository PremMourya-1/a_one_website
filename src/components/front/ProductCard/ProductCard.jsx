...
function ProductCard({ item }) {
  ...
  return (
    <>
      <div className="productCard shadow-md rounded-xl overflow-hidden group">
        <Link
          to={"/product/rich-dad-poor-dad"}
          className="imgBox block bg-white h-[200px] relative"
        >
          <img
            src={item.image}
            alt="product_image"
            className="h-full w-full max-w-[150px] m-auto object-contain transition-all group-hover:scale-110"
          />
        ...
        <div className="price flex justify-between  pt-2 border-t  bg-[#F1F1F1] px-2.5 py-4 border-white">
